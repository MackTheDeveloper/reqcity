...
$(document).on('click', '#search_recruiter_transaction', function () {
    ...
    $('#exportRecruiterTransaction #startDate').val(fromDate);
    $('#exportRecruiterTransaction #endDate').val(toDate);
    $('#exportRecruiterTransaction #status').val(status);
    $('#exportRecruiterTransaction #sub_plan').val(plan);
    DatatableInitiate(status, fromDate, toDate, plan);
});

$('#Tdatatable').on('search.dt', function () {
    var value = $('.dataTables_filter input').val();
    $('#exportRecruiterTransaction #search').val(value);
});
