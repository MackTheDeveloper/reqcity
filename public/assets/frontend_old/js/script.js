...
// footer menu color effect start

$(document).ready(function(){
  var f = "";
  if ($('.footer-menu li').hasClass('active')) {
  ...
  $('.footer-menu li').hover(
    function(){
      f = $(".footer-menu li").index( this );
      $(".footer-menu li").each(function(){
          if($(".footer-menu li").index(this) == f){
            $( this ).removeClass("blur")
          }
          else{
            $( this ).addClass("blur")
    ...
    function(){
      $('.footer-menu li').removeClass("blur")
    }
  )
})

// footer menu color effect end
...
function playVideo(event) { 
  var eventIs = event.target.className
  if (eventIs=='start') {
    ...
    a.children[0].play();
    a.children[1].classList.toggle("hide-icon")
  }else{
    var a = event.target.parentElement;
    a.children[0].pause();
    a.children[1].classList.toggle("hide-icon")
