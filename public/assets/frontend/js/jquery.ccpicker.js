 ...
 */
var dataJson = document.currentScript.getAttribute('data-json-path');
(function(factory) {
  ...
  $.extend(CcPicker.prototype, {
    ...
    createCountryList: function (e) {
      ...
      e._list = $("<ul/>", {"class": "cc-picker-code-list"}).appendTo(".number-groups");
      /* e._list.css({
        top: e._ccPicker.offset().top + e._ccPicker.outerHeight() + (e.options.countryFilter === true ? 39 : 0),
