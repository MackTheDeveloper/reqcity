                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            @if($model->id)
                                            <input type="hidden" class="form-control" id="slug" name="slug" placeholder="Enter Slug" value="{{$model->slug}}" />
                                            <input type="text" class="form-control" disabled id="slug" name="slug-show" placeholder="Enter Slug" value="{{$model->slug}}" />
                                            @else
