        ...
        <div class="app-header-right">
            <div class="header-dots">
                <div class="dropdown">
                    ...
                    @if ($unreadNotificationCount > 0)
                        <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown"
                            ...
                            <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                                ...
                                <i class="icon text-danger {{ $pulse }} ion-android-notifications"></i>
                                <span class='badge badge-dot badge-dot-sm {{ $badegeDanger }}'>Notifications</span>
                            </span>
                        </button>
                        <div tabindex="-1" role="menu" aria-hidden="true"
                            ...
                            <div class="dropdown-menu-header mb-0">
                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                    ...
                                    <div class="menu-header-content text-dark">
                                        ...
                                        <h6 class="menu-header-subtitle">You have <b>{{ $unreadNotificationCount }}</b>
                                            unread messages</h6>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <div><span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <h4 class="timeline-title">
                                                                        {{ $noti['message_type'] }}</h4>
                                                                    <p>{{ $noti['message'] }}</p><span
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item-btn text-center nav-item">
                                    <a href="{{ url('securerccontrol/notifications/index') }}"><button
                    ...
                    @else
                        <a href="{{ url('securerccontrol/notifications/index') }}" type="button" aria-haspopup="true"
                                    ...
                                    <div class="scroll-area-xs">
                                        <div class="scrollbar-container">
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="{{ url(config('app.adminPrefix') . '/profile') }}"
                                                        class="nav-link">My Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="{{ url(config('app.adminPrefix') . '/change/password') }}"
                                                        class="nav-link">Change Password
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="{{ url(config('app.adminPrefix') . '/logout') }}"
