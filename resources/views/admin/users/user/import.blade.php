            ...
            <div class="app-main__inner">
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{url(config('app.adminPrefix').'/user/list')}}">User List</a>
                                            </li>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form id="importUser" class="col-md-6" method="post" action="{{url(config('app.adminPrefix').'/user/import')}}" enctype="multipart/form-data">
                            @csrf                                                                                     
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{asset('public/excel-sample/user-sample-file.xls')}}" download><button type="button" class="btn btn-primary"><i class="fa fa-fw" aria-hidden="true"></i> Download Sample File</button></a>                                
                            </div>
                        </form>
                    </div>
                </div>  
