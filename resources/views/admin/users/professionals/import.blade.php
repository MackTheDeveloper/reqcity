...
<title>Import User | Fan Club</title>
            ...
            <div class="app-main__inner">
                                    ...
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active breadcrumb-item" aria-current="page">
                                               <a style="color: slategray">Import</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form id="importUser" class="col-md-6" method="post" action="{{url(config('app.adminPrefix').'/professional/import')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="position-relative form-group">
                                <label for="exampleFile" class="">File<span style="color:red">*</span></label>
                                <input name="import_user_file" id="import_user_file" type="file" class="form-control-file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-secondary" name="import" value="import">Import</button>
                                <a href="{{asset('public/excel-sample/professional-sample-file.xlsx')}}" download><button type="button" class="btn btn-secondary"><i class="fa fa-fw" aria-hidden="true"></i> Download Sample File</button></a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <nav class="" aria-label="breadcrumb">
                                ...
                                ?>
                                    ...
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                        ...
                                        {
                                        ?>
                                            <i class="fa fa-times"></i> <?php echo (count($uploaded) == 1) ? count($uploaded).'Row' : count($faile).'Rows' ; ?> uploaded successfully.<br/>
                                        <?php
                                        }
                                        ?>
                                    </div>
