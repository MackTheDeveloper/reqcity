            ...
            <div class="app-main__inner">
                ...
                <div id="common_msg">
                    @if(Session::has('message'))                        
                        <div class="alert {{Session::has('alert-class') == 'alert-success' ? 'alert-success' : Session::has('alert-class')}} alert-dismissible fade show" role="alert">
                            {{ Session::get('message') }}
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-account" role="tabpanel">
                                ...
                                <form id="updateCustomer" method="post" action="{{url(config('app.adminPrefix').'/customer/update')}}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{url(config('app.adminPrefix').'/customer/list')}}"><button type="button" class="btn btn-light" name="cancel" value="Cancel">Cancel</button></a>
                                    </div>
                                </form>
                            </div>
                            <div class="tab-pane" id="tab-address" role="tabpanel">                                
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form id="customerAddress" method="post" action="{{url(config('app.adminPrefix').'/customer/address')}}">
                                            @csrf
                                            <input type="hidden" name="customer_id" value="{{$customers->id}}">                                       
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="cities">City<span style="color:red">*</span></label>
                                                <div>
                                        ...
                                        <div id="address_list_section">
                                            @if(count($address_arr) > 0)
                                                ...
                                                <div class="card-shadow-secondary border mb-3 card card-body border-secondary">
                                                    ...
                                                    <div class="divider"></div>  
                                                    <div>
                                                        <a href="{{url(config('app.adminPrefix').'/customer/address/edit').'/'.$address['address_id'] }}"><button class="mb-2 mr-2 btn btn-shadow btn-outline-primary">Edit</button></a>
...
$(document).ready(function(){        
    ...
    $('#country').on('change', function(){
        ...
        $.ajax({
            url:'/securerccontrol/customer/states/' + country,
            method: "GET",
    ...
    $('#states').on('change', function(){
        var cities = $(this).val();        
        $.ajax({
            url:'/securerccontrol/customer/cities/' + cities,
            method: "GET",
            success: function(response) {
                if(response)
                {                    
    ...
    $('#customerDeleteAddress').click(function(){
        ...
        $.ajax({
            url:'/securerccontrol/customer/address/delete/' + address_id,
            method: 'GET',
            success: function(response)
            {                                
                ...
                {                                        
                    ...
                    if(response.address_arr.length > 0)
                    {
                        $.each(response.address_arr, function(i, v){                            
                            ...
                            output += '<div>'
                            output += '<a href="'+window.location.origin+'/securerccontrol/customer/address/edit/'+v.address_id+'"><button class="mb-2 mr-2 btn btn-shadow btn-outline-primary">Edit</button></a>'
