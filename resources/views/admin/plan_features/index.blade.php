...
<title>{{config('app.name_show')}} | Plan Features</title>
                ...
                <div class="app-page-title app-page-title-simple">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            ...
                            @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_plan_features_add') === true )
                                <a href="{{url(config('app.adminPrefix').'/plan-features/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add Plan Features</button></a>
                            @endif    
                            </div>
...
@section('modals-content')
    ...
    <div class="modal fade" id="templateIsActiveModel" tabindex="-1" role="dialog" aria-labelledby="templateIsActiveModelLabel" aria-hidden="true">
