...
<title>{{config('app.name_show')}} | Company Subscription </title>
            ...
            <div class="app-main__inner">
                <div class="app-page-title app-page-title-simple">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block">Company Subscriptions</span>
                                </div>
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="javascript:void(0);" style="color: grey">Company Subscriptions</a>
                                            </li>
                        ...
                        @endif --}}
                        <div class="page-title-actions">
                            @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_company_subscription_export') === true)
                            ...
                            {{ Form::open(array('url' => route('exportCompanySub'),'class'=>'exportSub','id'=>'exportSub','autocomplete'=>'off')) }}
...
<script>
    ...
    <script src="{{asset('public/assets/js/company_subscription/company_subscription.js')}}"></script>
    <script>
