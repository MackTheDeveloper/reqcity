...
<title>List Language | Fan Club</title>
            ...
            <div class="app-main__inner">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">                            
                            <div class="d-inline-block dropdown">                               
                                <a href="{{url(config('app.adminPrefix').'/language/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add Language</button></a>
                            </div>
                        </div>                                                  
                    </div>
                </div>  
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <table id="language_list" class="table table-hover table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>Language</th>
                                    <th>Sort Code</th>
