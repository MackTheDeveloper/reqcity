...
<title>Add Country | Fan Club</title>
            ...
            <div class="app-main__inner">
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{url(config('app.adminPrefix').'/countries')}}">Country List</a>
                                            </li>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form id="updateCountryForm" class="col-md-10 mx-auto" method="post"
                            action="{{url(config('app.adminPrefix').'/countries/updateCountry')}}">
                            @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select name="is_active" id="is_active" class="form-control">
                                                <option value="1" {{ ( $country->is_active == 1 ) ? 'selected' : '' }}>
                                                    Active</option>
                                                <option value="0" {{ ( $country->is_active == 0 ) ? 'selected' : '' }}>
                                                    Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{ url(config('app.adminPrefix').'/countries/') }}">
