...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar closed-sidebar">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">                            
                            <div class="d-inline-block dropdown">                               
                                <a href="{{url(config('app.adminPrefix').'/faq/addFaq')}}">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" class="form-inline">  
                            ...
                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                <label for="filter_faq" class="mr-sm-2">Languages</label>
    ...
    <!-- <div class="modal fade" id="faqIsActiveModel" tabindex="-1" role="dialog"
        aria-labelledby="faqIsActiveModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="faqIsActiveModelLabel">Confirmation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary" id="faqIsActive">Yes</button>
                </div>
            </div>
        </div>
    </div> -->
    ...
    <!-- Modal for delete FAQ -->
    <!-- <div class="modal fade" id="faqDeleteModel" tabindex="-1" role="dialog" aria-labelledby="faqDeleteModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="faqDeleteModelLabel">Confirmation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary" id="deletefaq">Yes</button>
                </div>
            </div>
        </div>
    </div> -->
