...
<title>List Currency | Fan Club</title>
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">                            
                            <div class="d-inline-block dropdown">                               
                                <a href="{{url(config('app.adminPrefix').'/currency/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add Currency</button></a>
                            </div>
                            <div class="d-inline-block dropdown">                               
                                <a href="{{url(config('app.adminPrefix').'/currencyConversion')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-exchange btn-icon-wrapper"></i> Add Currency Conversion Rate</button></a>
                            </div>
                        </div>                                                  
                    </div>
                </div>  
