    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="search-with-button">
                <input type="text" class="input search_text" id="search_text" name="search_text" placeholder="Search for recruiter" />
            ...
            <div class="company-portal-card new-to-old">
                ...
                <div class="ajaxRecruiterList">
                    @include(
                    'admin.recruiter-details.list.components.recruiter-list'
                    )
                </div>
            </div>

            <div class="job-posts not-found {{ !empty($recruiters['recruiters']) ? 'd-none' : '' }}">
                <div class="job-post-data">{{ config('message.frontendMessages.recordNotFound') }}</div>
            </div>

            <div class="joblist-loadmore text-center {{ empty($recruiters['recruiters']) ? 'd-none' : '' }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="deleteRecruiter">Yes</button>
            </div>
        </div>
    </div>
</div>
...
<script src="{{ asset('public/assets/js/recruiter/recruiters.js') }}"></script>
@endpush