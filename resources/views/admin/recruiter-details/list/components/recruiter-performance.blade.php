...
<script>
  ...
  let candidateApprovedCount = "{{$candidateApprovedCount}}";
  let candidateRejectedCount = "{{$candidateRejectedCount}}";
  let balance = "{{$balance}}";
  let payouts = "{{$payouts}}";
</script>
...
series1.data.setAll([
  { value: {{$candidateCount}}, category: "Candidates" ,colorB:0xeec200},
  { value: {{$candidateApprovedCount}}, category: "Approved",colorB:0x50b83c},
  { value: {{$candidateRejectedCount}}, category: "Rejected" ,colorB:0xde3618},
]);
