...
<title>{{config('app.name_show')}} | Company Transaction </title>
    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-heading">
                        <div>
                            <div class="page-title-head center-elem">
                                ...
                                <span class="d-inline-block">Company Transactions</span>
                            </div>
                            <div class="page-title-subheading opacity-10">
                                <nav class="" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="javascript:void(0);" style="color: grey">Company Transactions</a>
                                        </li>
            ...
            <div class="page-title-actions">
                @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_company_transaction_export') === true)
                ...
                {{ Form::open(array('url' => route('exportCompanyTransaction'),'class'=>'exportSub','id'=>'exportCompanyTransaction','autocomplete'=>'off')) }}
        ...
        <div class="card-body">
            ...
            <div>
                <form method="post" class="form-inline">
                    ...
                    <button type="button" id="search_company_transaction" class="btn btn-primary">Search</button>
                </form>
            </div>
        </div>
    </div>
...
@push('scripts')
<script src="{{asset('public/assets/js/transaction/company-transaction.js')}}"></script>
<script>
    ...
    $(document).on('click', '#exportBtn', function() {
        ...
        $('#exportCompanyTransaction').submit();
    })
</script>
@endpush
