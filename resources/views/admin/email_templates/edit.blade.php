...
<title>Update Email Templates | Fan Club</title>
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{url(config('app.adminPrefix').'/emailTemplates/list')}}">Multilanguage Email
                                                    Templates List</a>
                                            </li>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form id="addEmailTemplateForm" class="col-md-10 mx-auto" method="post"
                            action="{{url(config('app.adminPrefix').'/emailTemplates/updateTemplate')}}">
                            @csrf
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane tab_content" id="tab_{{$lang->id}}" role="tabpanel">
                                                ...
                                                <input class="form-control mail_subject" type="text"
                                                        ...
                                                        placeholder="Please enter subject" value = "@foreach($footer_details as $detail){{ in_array($lang->id, $detail->toArray()) ? $detail->subject : ''}}@endforeach">
                                                ...
                                                <div>
                                                    ...
                                                    <textarea name="value[{{ $lang->id }}]" id="value_{{ $lang->id }}"
                                                        type="text" class="form-control ckeditor">
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{ url(config('app.adminPrefix').'/emailTemplates/list') }}">
