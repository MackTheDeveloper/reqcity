...
<title>Candidate Submit 2</title>
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="row">
                              ...
                              <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label class="font-weight-bold">What is it about your current position that you don't like that you are looking for in your next opportunity?
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div>
                                        <textarea class="form-control"></textarea>
                              ...
                              <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold">When are you available to start your next opportunity?
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div>
                              ...
                              <div class="col-sm-12 col-md-12 radio-groups">
                                ...
                                <div class="custom-radio custom-control custom-control-inline">
                                  <input type="radio" id="filterable1" name="filterable" class="custom-control-input" value="yes">
                                  <label class="custom-control-label" for="filterable1">Yes</label>
                                </div>
                                <br>
                                <div class="custom-radio custom-control custom-control-inline">
                                  <input type="radio" id="filterable2" name="filterable" class="custom-control-input" value="no">
                                  <label class="custom-control-label" for="filterable2">No</label>
                                </div>
                              </div>

                              <div class="col-sm-12 col-md-12 radio-groups">
                                <label class="font-weight-bold">Are you aware of the COVID situation and precautions to be taken?
                                  <span class="text-danger">*</span>
                                </label>
                                <br>
                                <div class="custom-radio custom-control custom-control-inline">
