...
<title>{{config('app.name_show')}} | Footer </title>
                ...
                <div class="app-page-title app-page-title-simple">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            ...
                            @if(whoCanCheck(config('app.arrWhoCanCheck'), 'admin_footer_add') === true)
                            <div class="d-inline-block dropdown">
                                <a href="{{url(config('app.adminPrefix').'/footer-link/add')}}"><button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm"><i class="fa fa-plus btn-icon-wrapper"> </i>Add Footer</button></a>
                            </div>
                            @endif
                        </div>
                    </div>
...
<!-- Modal for activating deactivating template -->
    <div class="modal fade" id="footerIsActiveModel" tabindex="-1" role="dialog" aria-labelledby="footerIsActiveModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="footerIsActiveModelLabel">Confirmation</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="footerIsActive">Yes</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="footerDeleteModel" tabindex="-1" role="dialog" aria-labelledby="footerDeleteModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="footerDeleteModelLabel">Confirmation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary" id="deleteFooter">Yes</button>
                </div>
            </div>
        </div>
    </div>
