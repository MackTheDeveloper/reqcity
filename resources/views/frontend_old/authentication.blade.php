...
<section class="authentication-page mw-352">
    <div class="authenti-con">
        <h2 data-aos="fade-right">Authentication</h2>
    ...
    <form method="post" id="verifyUserForm" action="">
        @csrf
        @if(!Auth::check())
        ...
        <div class="resend-otp" data-aos="fade-up">
            <a class="resendOtp" href="javascript:void(0)">Resend Code</a>
        </div>
        <button type="submit" id="fifth" class="fill-btn verify-btn" data-aos="fade-up">VERIFY</button>
    </form>
</section>
