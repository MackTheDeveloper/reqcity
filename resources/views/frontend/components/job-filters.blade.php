            ...
            <div class="ck-collapse-wrapper">
              <div class="ck-collapse">
                ...
                <label class="ck">{{ $parentCategories['name']}}
                  <input <?php if(isset($catID) && !empty($catID)){if($catID==$parentCategories['id']) echo "checked";}?> type="checkbox" class="parent_cat" value="{{$parentCategories['id']}}" name="parent_cat[]" />
                  <span class="ck-checkmark"></span>
                </label>
                @endforeach
                @endif
