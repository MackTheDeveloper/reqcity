<div class="action-block">
    ...
    <a href="javascript:void(0)" data-id="{{$id}}"
        data-target="#reqEidtUser" id="edit-btn">
        <img src="{{ asset('public/assets/frontend/img/pencil.svg') }}"
            alt="" />
    </a>
    @endif
    @if ($isDeletable)
    <a href="javascript:void(0)" id="delete-btn" class="delete-module-item" data-id="{{$id}}" data-module="{{$module}}"><img src="{{ asset('public/assets/frontend/img/delete.svg') }}"
            alt="" /></a>
    @endif
</div>
    ...
    <div
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item"
                id="edit-btn"
                data-target="#reqEidtUser" data-id="{{$id}}" href="javascript:void(0)">
                <img src="{{ asset('public/assets/frontend/img/pencil.svg') }}"
                    alt="" />
                <span>Edit</span>
            </a>
