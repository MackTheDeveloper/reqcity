                        ...
                        <div class="accounts-boxlayouts">
                            <div class="ac-boclayout-header">
                                ...
                                <div class="boxlayouts-edit">
                                    @if(whoCanCheckFront('company_user_management_post'))
                                        ...
                                        <div class="user-management-tabs">
                                            ...
                                            <div class="tab-content usermanagement-tabcontent" id="pills-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                                    ...
                                                    @include('frontend.company.components.user-dropdown')
                                                </div>
                                            </div>
...
<!-- ADD USER Modal -->
<!-- Edit USER Modal -->
@include('frontend.company.components.modals.company-user-form')
<!-- confirm Modal -->
@include('frontend.components.delete-confirm',['title'=>'Remove User','message'=>'Are you sure you want to remove the user?'])
...
<script type="text/javascript">
    ...
    $(document).on('change', '#user-list', function() {
        var id = $(this).val();
        $.ajax({
            url: "{{ route('companyUserPermission') }}",
            type: "GET",
            data: {
                'id': id
            },
    ...
    $(document).on('change', '.permission', function() {
        ...
        $.ajax({
            url: "{{ route('companyUserChangePermission') }}",
            type: "GET",
            data: {
                'userId': userId,
