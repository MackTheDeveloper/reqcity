        ...
        <div class="container">
            ...
            <div class="JDF-wrapper">
                ...
                <form id="companyJobForm" method="POST"
                    action="{{ $model->id ? route('jobDetailsUpdate', $model->id) : route('jobDetailsAdd') }}">
                    @csrf
                    <div class="JDF-box">
                        <div class="basic-info">
                            ...
                            <div class="row">
                                    ...
                                    <div class="input-groups">
                                        ...
                                        <select name="company_address_id" id="company_address_id">
                                            @foreach ($jobLocations as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $key == $model->company_address_id ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 showHideAddr {{ $model->company_address_id ? 'd-none' : '' }}">
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-6">
                                            <div class="input-groups">
                                                <span>City</span>
                                            ...
                                            <div class="input-groups">
                                                ...
                                                <select name="address[country]" id="address_country">
                                                    @foreach ($countries as $key => $row)
                                                        <option {{$row['key']=='231'?"selected":""}} value="{{ $row['key'] }}">{{ $row['value'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="input-groups">
                                        ...
                                        <select name="job_category_id" id="job_category_id">
                                            ...
                                            @foreach ($parentCategories as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $key == $model->job_category_id ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <select name="job_subcategory_id" id="job_subcategory_id">
                                            ...
                                            @foreach ($childCategories as $key => $value)
                                                <option value="{{ $value->id }}"
                                                    {{ $value->id == $model->job_subcategory_id ? 'selected' : '' }}>
                                                    {{ $value->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                {{-- <div class="col-12 col-sm-12 col-md-6">
                                <div class="input-groups">
                                    <span>What industry does this job fall under?</span>
                                    <select name="job_industry_id" id="job_industry_id">
                                        <option value="">Select</option>
                                        @foreach ($jobIndustries as $key => $row)
                                        <option value="{{ $row['key'] }}" {{ $row['key'] == $model->job_industry_id ? 'selected' : '' }}>
                                            {{ $row['value'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                        ...
                                        <select name="job_employment_type_id" id="job_employment_type_id">
                                            ...
                                            @foreach ($employmentType as $key => $row)
                                                <option value="{{ $row['key'] }}"
                                                    {{ $row['key'] == $model->job_employment_type_id ? 'selected' : '' }}>
                                                    {{ $row['value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-groups">
                                        ...
                                        <div class="multi-select-dropdown">
                                            ...
                                            <div class="multi-dropdown-list">
                                                @foreach ($jobSchedule as $key => $row)
                                                    <label class="ck">{{ $row['value'] }}
                                                        <input name="job_schedule_ids[]" type="checkbox"
                                                            class="ck check" value="{{ $row['key'] }}"
                                                            {{ in_array($row['key'], $model->job_schedule_ids) ? 'checked' : '' }}>
                                    ...
                                    <div class="input-groups">
                                        ...
                                        <select name="job_contract_id" id="job_contract_id">
                                            ...
                                            @foreach ($contractType as $key => $row)
                                                <option value="{{ $row['key'] }}"
                                                    {{ $row['key'] == $model->job_contract_id ? 'selected' : '' }}>
                                                    {{ $row['value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-groups">
                                        ...
                                        <div class="input-select">
                                            <input type="text" name="contract_duration" id="contract_duration"
                                                value="{{ $model->contract_duration }}" />
                                            <select class="width-136" name="contract_duration_type"
                                                id="contract_duration_type">
                                                <option {{ $model->contract_duration_type == '1' ? 'selected' : '' }}
                                                    value="1">Month(s)</option>
                                                <option {{ $model->contract_duration_type == '2' ? 'selected' : '' }}
                                ...
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <select name="relocation_available" id="relocation_available">
                                            <option {{ $model->relocation_available == 'yes' ? 'selected' : '' }}
                                                value="yes">Yes</option>
                                            <option {{ $model->relocation_available == 'no' ? 'selected' : '' }}
                                                value="no">No</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <select name="sponsorship_available" id="sponsorship_available">
                                            <option {{ $model->sponsorship_available == 'yes' ? 'selected' : '' }}
                                                value="yes">Yes</option>
                                            <option {{ $model->sponsorship_available == 'no' ? 'selected' : '' }}
                                                value="no">No</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <select name="required_travelling" id="required_travelling">
                                            <option {{ $model->required_travelling == 'yes' ? 'selected' : '' }}
                                                value="yes">Yes</option>
                                            <option {{ $model->required_travelling == 'no' ? 'selected' : '' }}
                                                value="no">
                                                No</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        {{-- <span>Can this job be performed remotely?</span> --}}
                                        <select name="job_remote_work_id" id="job_remote_work_id">
                                            {{-- <option {{$model->job_remote_work_id == 0 ? 'selected' : ''}} value="0">No</option> --}}
                                            @foreach ($remoteWork as $key => $row)
                                                <option value="{{ $row['key'] }}"
                                                    {{ $row['key'] == $model->job_remote_work_id ? 'selected' : '' }}>
                                                    {{ $row['value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <div class="number-counter">
                                            <input type="number"
                                                value="{{ !empty($model->vaccancy) ? $model->vaccancy : 1 }}"
                                ...
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <select name="salary_type" id="salary_type">
                                            <option {{ $model->salary_type == 'hour' ? 'selected' : '' }} value="hour">
                                                Hourly</option>
                                            <option {{ $model->salary_type == 'week' ? 'selected' : '' }} value="week">
                                                Weekly</option>
                                            <option {{ $model->salary_type == 'month' ? 'selected' : '' }} value="month">
                                                Monthly</option>
                                            <option {{ $model->salary_type == 'year' ? 'selected' : '' }} value="year">
                                                Yearly</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <select name="compensation_type" id="compensation_type">
                                            <option {{ $model->compensation_type == 'r' ? 'selected' : '' }} value="r">
                                                Range</option>
                                            <option {{ $model->compensation_type == 'f' ? 'selected' : '' }} value="f">
                                                Fixed</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-4">
                                    <div class="input-groups">
                                        ...
                                        <input type="number" name="from_salary" id="from_salary"
                                            value="{{ $model->from_salary }}" />
                                    </div>
                                </div>

                                <div
                                    class="col-6 col-sm-6 col-md-4 compensation-to {{ $model->compensation_type == '' || $model->compensation_type == 'r' ? '' : 'd-none' }}">
                                    <div class="input-groups">
                                        <span>Compensation To ($):</span>
                                        <input type="number" name="to_salary" id="to_salary"
                                            value="{{ $model->to_salary }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-4">
                                    <div class="input-groups prevent-selection">
                                        ...
                                        <select name="pay_duration" id="pay_duration">
                                            <option {{ $model->pay_duration == 'per hour' ? 'selected' : '' }}
                                                value="per hour">per hour</option>
                                            <option {{ $model->pay_duration == 'per week' ? 'selected' : '' }}
                                                value="per week">per week</option>
                                            <option {{ $model->pay_duration == 'per month' ? 'selected' : '' }}
                                                value="per month">per month</option>
                                            <option {{ $model->pay_duration == 'per year' ? 'selected' : '' }}
                                ...
                                <div class="col-12 comp-checkbox">
                                    <label class="ck">Hide compensation details to candidates
                                        <input type="checkbox" name="hide_compensation_details_to_candidates"
                                            {{ $model->hide_compensation_details_to_candidates == 'yes' ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <div class="multi-select-dropdown">
                                            <label class="multi-dropdown-label"></label>
                                            <div class="multi-dropdown-list">
                                                @foreach ($payOffered as $key => $row)
                                                    <label class="ck">{{ $row['value'] }}
                                                        <input name="supplemental_pay_offered_ids[]" type="checkbox"
                                                            class="ck check" value="{{ $row['key'] }}"
                                                            {{ in_array($row['key'], $model->supplemental_pay_offered_ids) ? 'checked' : '' }}>
                                                        <span class="ck-checkmark" values="{{ $row['value'] }}"></span>
                                                    </label>
                                                @endforeach
                                            </div>
                                        ...
                                        <!--  <select name="supplemental_pay_offered_ids[]" id="supplemental_pay_offered_ids" multiple>
                                                @foreach ($payOffered as $key => $row)
    <option value="{{ $row['key'] }}" {{ in_array($row['key'], $model->supplemental_pay_offered_ids) ? 'selected' : '' }}>
                                                    {{ $row['value'] }}</option>
    @endforeach
                                            </select> -->
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <div class="multi-select-dropdown">
                                            <label class="multi-dropdown-label"></label>
                                            <div class="multi-dropdown-list">
                                                @foreach ($benifitsOffered as $key => $row)
                                                    <label class="ck">{{ $row['value'] }}
                                                        <input name="benefits_offered_ids[]" type="checkbox"
                                                            class="ck check" value="{{ $row['key'] }}"
                                                            {{ in_array($row['key'], $model->benefits_offered_ids) ? 'checked' : '' }}>
                                                        <span class="ck-checkmark"
                                                            values="{{ $row['value'] }}"></span>
                                                    </label>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <!-- <select name="benefits_offered_ids[]" id="benefits_offered_ids" multiple>
                                                @foreach ($benifitsOffered as $key => $row)
    <option value="{{ $row['key'] }}" {{ in_array($row['key'], $model->benefits_offered_ids) ? 'selected' : '' }}>
                                                    {{ $row['value'] }}</option>
    @endforeach
                                            </select> -->
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="input-groups">
                                        ...
                                        <input type="text" name="additional_benefits" id="additional_benefits"
                                            value="{{ $model->additional_benefits }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-groups">
                                        ...
                                        <input type="text" name="job_short_description" id="job_short_description"
                                            value="{{ $model->job_short_description }}" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="input-groups custome-ck-editor">
                                        <span>Describe the roles and responsibilities of this job</span>
                                        <textarea class="" id="editor1" name="job_description">{{ $model->job_description }}</textarea>
                                        <div class="max-note">
                                ...
                                <div class="col-12">
                                    <div class="input-groups">
                                        ...
                                        <textarea name="covid_precautions">{{ $model->covid_precautions }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#job_category_id').change(function() {
                ...
                $.ajax({
                    url: "{{ url('company-job/get-subcat') }}",
                    type: 'post',
                    dataType: "json",
