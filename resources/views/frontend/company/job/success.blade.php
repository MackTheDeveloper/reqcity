    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">   
                ...
                <p class="bl blur-color">Payment ID: {{$paymentId}}</p>
                <hr class="hr">
                <p class="bl blur-color">Your payment is successful for created job post.</p>
                <div class="success-btn-block">
                <a href="{{route('showDashboard')}}" class="border-btn">Go to Dashboard</a>
                </div>
            </div>
        </div>
    </div>
