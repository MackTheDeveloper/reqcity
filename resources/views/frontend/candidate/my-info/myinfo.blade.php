            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-9">
                <div class="right-sides-items">
                    <div class="myinfo-page">
                        ...
                        <div class="accounts-boxlayouts" id="show-account-info">
                            <div class="ac-boclayout-header">
                                <div class="boxheader-title">
                                    <h6>Account Info</h6>
                                    <span>{{$candidate->user->unique_id?:'-'}}</span>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-6">
                                        <div class="boxlayout-infoitem">
                                            ...
                                            <p>{{$candidate->user->firstname?:'-'}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Last name</span>
                                            <p>{{$candidate->user->lastname?:'-'}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-6">
                                        <div class="boxlayout-infoitem">
                                    ...
                                    <div class="col-md-12 col-lg-6">
                                        <div class="boxlayout-infoitem">
                                            ...
                                            <p>{{$candidate->phone_ext?:'-'}}-{{$candidate->phone?:'-'}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @include('frontend.candidate.my-info.components.edit-account-info')
                        <!-- Start Box Item Layout reusable -->
                            ...
                            <div class="ac-boxlayouts-desc">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Country</span>
                                            <p>{{$candidate->Country->name ? :'-'}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Address line 1</span>
                                            <p>{{$candidate->address_1?:'-'}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Address line 2</span>
                                            <p>{{$candidate->address_2?:'-'}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                    ...
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                            ...
                                            <div class="static-resumeinfo">
                                                @if($resumeLink)
                                                <a href="{{$resumeLink}}" download><img src="{{asset('public/assets/frontend/img/pdf-orange.svg')}}" /></a>
                                                <p>Download Resume</p>
                                                @else
                                                <p>-</p>
                                                @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                            <span>LinkedIn</span>
                                            <p>{{$candidate->linkedin_profile_link?:'-'}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Ends Box Item Layout reusable -->
                        @include('frontend.candidate.my-info.components.edit-about-info')
                    </div>
                </div>
            </div>
        </div>
