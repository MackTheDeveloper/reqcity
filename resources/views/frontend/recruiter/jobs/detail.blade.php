        ...
        <div class="row">
            <div class="order-2 order-xl-1 col-lg-12 col-xl-9">
                <div class="req-job-header">
                    <a href="{{ route('recruiteryJobs', 'all') }}" class="back-to-link bm"><img src="{{ asset('public/assets/frontend/img/arrow-left.svg') }}" alt="" />Back to all
                        jobs</a>
                    <p class="tl">{{ $model->title }}</p>
                    <p class="ts blur-color">{{ $model->company->name }}</p>
                    <p class="ts blur-color">{{ $model->CompanyAddress->city }},
                        {{ $model->CompanyAddress->state ? ','.$model->CompanyAddress->state :''}}
                        {{ $model->CompanyAddress->countries->name }}</p>
                    @if ($model->to_salary)
                    ...
                    <div class="rac-table-wrapper">
                        <div class="rac-table">
                            ...
                            <div class="rac-row">
                                ...
                                <div class="rac-column">
                                    @if ($value['latest_cv'])
                                    <a href="{{ $value['latest_cv'] }}" class="pdf-link" target="_blank">
                                ...
                                <div class="rac-column">
                                    <div class="flex-apply">
                                        <div class="view-icon-block">
                                            <a href="javascript:void(0)" class="icon-btns view_candidate" data-id="{{ $value['id'] }}">
                                                <img src="{{ asset('public/assets/frontend/img/view-icon.svg') }}" alt="" />
                                            </a>
                                        </div>
                                        <a href="{{ $value['linkedin_profile'] }}" class="linkdin-btns" target="_blank">
                        ...
                        @if(!$modelCandidates)
                        <div class="rac-error">
                            <p class="ll blur-color">No candidates found</p>
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="order-1 order-xl-2 col-lg-12 col-xl-3">
                <div class="req-job-post-box">
                    <div class="job-post-status">
                        <a href="{{ route('recruiterCandidateSubmitStart', $model->slug) }}" class="fill-btn">Submit Candidate</a>
                        <label class="bk">
                            <input type="checkbox" class="makeFavourite" {{ $extra['isFavourite'] ? 'checked' : '' }} />
