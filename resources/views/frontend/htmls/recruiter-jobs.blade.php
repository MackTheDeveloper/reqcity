...
<head>
	<meta charset="utf-8">
	<title>Reqcity | Recruiter Jobs</title>
	<meta charset="utf-8">
    ...
    <div class="container">
      <div class="tab-section" id="navbar-example2">
        <ul>
          ...
          <li><a data="" class="tab-link">Favorites</a></li>
          <li><a data="" class="tab-link">Submitted</a></li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="job-data-wrapper">
        ...
        <div class="job-posts">
          <div class="job-post-data">
            ...
            <p class="ll blur-color">Nutrify, Inc.</p>
            <p class="ll blur-color">San Francisco, CA</p>
            <p class="bm blur-color">Sed in velit ipsum. Maecenas molestie tellus eu egestas vestibulum. Phasellus ullamcorper orci risus, id rhoncus lacus mollis tempus.</p>
            <div class="job-table">
              ...
              <div class="last-data">
                          ...
                          <ul>
                            <li>
                              <a href="" >
                                ...
                                <span class="bm">Abigail Abraham</span>
                              </a>
                            </li>
                            <li>
                              <a href="" >
                                <img src="assets/img/m2.png" alt="" />
                                <span class="bm">Hanna Franci</span>
                              </a>
                            </li>
                            <li>
                              <a href="" >
                                <img src="assets/img/m3.png" alt="" />
                                <span class="bm">Kaiya Westervelt</span>
                              </a>
                            </li>
                            <li>
                              <a href="" >
                                <img src="assets/img/m4.png" alt="" />
                                <span class="bm">Ann Lubin</span>
                              </a>
                            </li>
                          </ul>
                        </div>
                ...
                <div class="job-table-data">
                  <div class="jtd-wrapper">
                    ...
                    <div class="hoverd-data-wrapper center">
                      <div class="hoverd-data-outer">
                        <div class="hoverd-data-inner">
                          <ul>
                            <li>
                ...
                <div class="job-table-data">
                  <div class="jtd-wrapper">
                    <label class="ll">7</label>
                    <span class="bs blur-color">Remaining Approvals</span>

                    <div class="hoverd-data-wrapper right">
                      <div class="hoverd-data-outer">
                        <div class="hoverd-data-inner">
                          <ul>
                            <li>
          ...
          <div class="job-post-status">
            <button class="fill-btn">Submit Candidate</button>
            <label class="bk">
              <input type="checkbox" />
