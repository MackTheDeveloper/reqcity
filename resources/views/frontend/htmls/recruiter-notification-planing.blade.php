...
<head>
    <meta charset="utf-8">
    <title>Reqcity | Notification Planing</title>
    <meta charset="utf-8">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-3">
                    <div class="left-sides-bar">
                        ...
                        <ul class="dropdowns-toggles">
                            <li>
                                <a class="myinfo-link" href="recruiter-myinfo.html">My Info</a>
                            </li>
                            <li>
                                <a class="payments-link" href="recruiter-payment.html">Payments</a>
                            </li>
                            <li>
                                <a class="passsecuri-link" href="recruiter-password-security.html">Password &
                                    Security</a>
                            </li>
                            <li>
                                <a class="subsc-link" href="recruiter-subscription-plan.html">Subscription Plan</a>
                            </li>
                            <li class="active">
                                <a class="noti-link" href="recruiter-notification-planing.html">Notification
                                    Settings</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="right-sides-items">
                        <div class="notification-setting-page">
                            ...
                            <div class="accounts-boxlayouts">
                                <div class="ac-boclayout-header">
                                    <div class="boxheader-title">
                                        <h6>Other ReqCity Email Updates</h6>
                                        <!-- <span>R01532</span> -->
                                    </div>
                                    <div class="boxlayouts-edit">
                                        <a><img src="/assets/img/pencil.svg" /></a>
                                ...
                                <div class="ac-boxlayouts-desc">
                                    <div class="email-updates-request">
                                        <p>Send email notification to r*******r@domain.com when...</p>
                                        <div class="emailupdates-checknow">
                                            <div class="input-groups">
                                                <label class="ck">A candidate is accepted or rejected
                                                    <input type="checkbox" />
                                                    <span class="ck-checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="input-groups">
                                                <label class="ck">Candidate’s profile is viewed
                                                    <input type="checkbox" />
                                                    <span class="ck-checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="input-groups">
                                                <label class="ck">Payout related event occur
                                                    <input type="checkbox" />
                                                    <span class="ck-checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="input-groups">
                                                <label class="ck">A job posting expired
                                                    <input type="checkbox" />
                                                    <span class="ck-checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="input-groups">
                                                <label class="ck">Subscription related event occur
                                                    <input type="checkbox" />
                                                    <span class="ck-checkmark"></span>
                                                </label>
                                            </div>
