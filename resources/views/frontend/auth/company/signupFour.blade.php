@section('title', 'Company Signup 4')
    ...
    <div class="comp-signup4-payment">
        <div class="container">
            <div class="process-progress">
                ...
                <div class="info-progress done">
                    <div class="numbers"><a href="{{ route('showThirdCompanySignup') }}"
            ...
            <div class="signup4-pay-inn">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 offset-xl-1 col-xl-6">
                        <form action="{{ route('companySignupFourth') }}" method="post" id="companySignupFormFour">
                            @csrf
                                ...
                                <div class="pay-methodin">
                                    <label class="rd">Stripe
                                        ...
                                        <span class="payee-img">
                                            <img src="{{ asset('public/assets/frontend/img/visa.svg') }}"
                                                alt="paymentmethod" />
                                            <img src="{{ asset('public/assets/frontend/img/master.svg') }}"
                                                alt="paymentmethod" />
                                            <img src="{{ asset('public/assets/frontend/img/american_express.svg') }}"
                                                alt="paymentmethod" />
                                            <img src="{{ asset('public/assets/frontend/img/discover.svg') }}"
                                                alt="paymentmethod" />
                                        </span>
                                        ...
                                        <div class="col-12 col-sm-12">
                                            <div class="input-groups">
                                                ...
                                                <div class="card-field">
                                                    <input type="text" class="input" name="card_no" id="cardnumber"
                            ...
                            <div class="payin-summary">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>${{ $getCurrentSubscription->price }}/{{ $getCurrentSubscription->plan_type == 'monthly' ? 'month' : 'year' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Valid until:
                                ...
                                @if (!empty($getCurrentSubscription->trial_period))
                                    <div class="payin-notes">
                                        <span>*Free trial ends on {{ getFormatedDate($trialDates['trialEndDate']) }}, your
                                            card will be charged on
                                            {{ getFormatedDate($trialDates['billingStartDate']) }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
...
@endsection
@section('footscript')
    <script src="{{ asset('public/assets/frontend/js/card.js') }}"
        data-base-url="{{ asset('public/assets/frontend/img') }}"></script>
    <script src='https://cdnjs.cloudflare.com/ajax/libs/imask/3.4.0/imask.min.js'></script>
    <script type="text/javascript">
        $(document).ready(function() {

        });
        $("#companySignupFormFour").validate({
          ignore: [],
          rules: {
            "card_name": "required",
            "card_no": "required",
