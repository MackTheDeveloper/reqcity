    ...
    <div class="row">
      <div class="col-md-12 order-2 order-lg-1 col-lg-8 col-xl-9">
        <div class="job-detail-data">
          <a href="<?php echo e(url('/company-jobs')); ?>" class="back-to-link bm"><img src="<?php echo e(asset('public/assets/frontend/img/arrow-left.svg')); ?>" alt="" />Back to all
            jobs</a>
          <?php echo $__env->make('frontend.company.jobs.components.job-performance', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          <hr class="hr mtb-35">
            <?php echo $__env->make('frontend.company.jobs.components.candidate-data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          <hr class="hr candi-hr">
            <?php echo $__env->make('frontend.company.jobs.components.job-description', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
      </div>
      <div class="col-md-12 order-1 order-lg-2 col-lg-4 col-xl-3">
        <div class="job-post-box">
          <p class="tl"><?php echo e($jobDetails->title); ?></p>
          <p class="bm blur-color"><?php echo e($jobDetails->companyAddress->city); ?><?php echo e($jobDetails->companyAddress->state ? ', '.$jobDetails->companyAddress->state :''); ?><?php echo e($jobDetails->CompanyAddress->countries->name ? ', '.$jobDetails->CompanyAddress->countries->name :''); ?></p>
          <p class="ll"><?php echo e($salary); ?> a <?php echo e($jobDetails->salary_type); ?></p>
          <div class="dropdown status_dropdown" data-color="<?php echo e($statusColor ? $statusColor : ''); ?>">
            <button
            ...
            <ul class="dropdown-menu status_change" aria-labelledby="dropdownMenuButton1">
              <?php if($jobDetails->status === 3 || $jobDetails->status === 2): ?>
              <li>
                <a class="dropdown-item job-change-status" data-class="open" data-status="1" data-id="<?php echo e($jobDetails->id); ?>" href="javascript:void(0)" data-toggle="modal" data-target="#ChageStatusModel">
                  <div class="status-round"></div>Open
                </a>
              </li>
              <?php endif; ?>
              <?php if($jobDetails->status === 1 ): ?>
              <li>
                <a class="dropdown-item job-change-status" data-class="paused" data-status="3" data-id="<?php echo e($jobDetails->id); ?>" href="javascript:void(0)" data-toggle="modal" data-target="#ChageStatusModel">
              ...
              <?php if($jobDetails->status === 1): ?>
              <li>
                <a class="dropdown-item job-close" data-class="closed" data-id="<?php echo e($jobDetails->id); ?>" href="javascript:void(0)" data-toggle="modal"
...
function displayCompanyJobGraph() {
  var origin = window.location.href;
    ...
    $.ajax({
        url: '../company-job-details/monthly-graph/'+<?php echo e($jobDetails->id); ?>,
        method: 'GET',
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/company/jobs/job_details.blade.php ENDPATH**/ ?>