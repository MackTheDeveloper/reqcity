...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('frontend.recruiter.jobs.components.job-tabs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="job-data-wrapper">
                ...
                <?php if(!empty($jobListData)): ?>
                    <div class="ajaxJobList">
                        <?php echo $__env->make(
                            'frontend.recruiter.jobs.components.job-list'
...
<?php $__env->startSection('footscript'); ?>
    <script type="text/javascript">
        ...
        $(document).on("click", ".makeFavourite", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(url('/recruiter-jobs/make-favorite')); ?>",
                type: "POST",
                data: {
                    jobId: jobId,
        ...
        $('input[type="checkbox"]').on('change', function() {
            if ($(this).hasClass('checkAllOption')) {
                if ($(this).prop('checked')) {
                    $(this).closest('.input-groups').find('input[type="checkbox"]:checked').not('.checkAllOption')
                        .prop(
                            "checked", false).trigger('change');
                }
            } else {
                if ($(this).prop('checked')) {
                    $(this).closest('.input-groups').find('input.checkAllOption').prop("checked", false).trigger(
                        'change');
                }
            }
        });
        ...
        function sortSearchFilterAjax(page = "1", append = 0) {
            ...
            $.ajax({
                url: "<?php echo e(route('ajaxJobListForRecruiter')); ?>",
                method: 'post',
                data: 'search=' + search + '&page=' + page + '&status=' + status + '&sort=' + sort +
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/recruiter/jobs/index.blade.php ENDPATH**/ ?>