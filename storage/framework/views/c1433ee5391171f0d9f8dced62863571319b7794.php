            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-9">
                <div class="right-sides-items">
                    <div class="myinfo-page myinfo-compnaey">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Your name</span>
                                            <p><?php echo e($data->companyUserName); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Email</span>
                                            <p><?php echo e($data->userEmail); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Company name</span>
                                            <p><?php echo e($data->companyName); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Phone number</span>
                                            <p><?php echo e($data->companyUserPhoneExt); ?>-<?php echo e($data->companyUserPhone); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php echo $__env->make('frontend.company.my-info.components.account-info-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <!-- Start Box Item Layout reusable -->
                        <div class="accounts-boxlayouts" id="show-company-form">
                            <div class="ac-boclayout-header">
                                ...
                                <div class="boxlayouts-edit">
                                    ...
                                    <a><img src="<?php echo e(asset('public/assets/frontend/img/pencil.svg')); ?>" id="edit-company" /></a>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                            ...
                                            <p><?php echo e($data->strength); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                            <span>Email</span>
                                            <p><?php echo e($data->companyEmail); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="boxlayout-infoitem">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="myinfos-abt-work">
                                            ...
                                            <p><?php echo e($data->why_work_here); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Ends Box Item Layout reusable -->
                        <?php echo $__env->make('frontend.company.my-info.components.company-info-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $.validator.addMethod('companyUniqueEmail', function(value, element) {
        ...
        $.ajax({
            async: false,
            url: "<?php echo e(route('companyUniqueEmail')); ?>",
            method: 'post',
            data: {
                email: email,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/company/my-info/myinfo.blade.php ENDPATH**/ ?>