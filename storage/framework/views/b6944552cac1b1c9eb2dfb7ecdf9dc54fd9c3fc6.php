...
<div class="recruiter-candidates">
    <div class="container">
        <div class="rc-header">
            <h5>Candidates</h5>
            <button class="fill-btn" data-title="Add Candidate" data-toggle="modal" value="<?php echo e(route('createRecruiterCandidates')); ?>" id="btnAddRecruiterCandidate">Add Candidate</button>
        </div>
...
<?php echo $__env->make('frontend.recruiter.candidate.components.add-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('frontend.components.delete-confirm',['title'=>'Remove Candidate','message'=>'Are you sure you want to remove the candidate?'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    function candidateList(search = '', posted = '') {
        $('#magTable').magTable({
            ajax: {
                "url": "<?php echo e(route('recruiterCandidatesList')); ?>",
                "type": "GET",
                "data": {
                    "search": search,
                    "posted": posted,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/recruiter/candidate/index.blade.php ENDPATH**/ ?>