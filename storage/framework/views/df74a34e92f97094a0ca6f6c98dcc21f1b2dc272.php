<div class="modal fade modal-structure close-job-popup" id="closeJob">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form id="balanceRequestFromPopup" method="POST" action="<?php echo e(url('/balance-transfer-request')); ?>">
          <?php echo csrf_field(); ?>
      <!-- Modal Header -->
...
<?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/company/jobs/modals/close-popup.blade.php ENDPATH**/ ?>