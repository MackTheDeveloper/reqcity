...
<?php $filename='frontend.'.$roleText.'.include.sidebar';?>
    <section class="profiles-pages compnay-profile-pages">
        <div class="container">
            <div class="row">
                <?php echo $__env->make($filename, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('frontend.components.delete-confirm',['title'=>'Delete Notification','message'=>'Are you sure ?'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('footscript'); ?>
    ...
    <script type="text/javascript">
        ...
        function notificationList(startDate = '', endDate = '') {
            $('#magTable').magTable({
                ajax: {
                    "url": "<?php echo e(route('notificationsList')); ?>",
                    "type": "GET",
                    "data": {
                        "startDate": startDate,
                        "endDate": endDate
        ...
        $(document).on('click', '#readunread-btn', function() {
            var id = $(this).data().id;
            $.ajax({
                url: "<?php echo e(route('notificationReadunread')); ?>",
                data: {
                    "id": id
                },
                type: "GET",
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/notifications/index.blade.php ENDPATH**/ ?>