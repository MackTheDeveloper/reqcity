<div class="modal fade modal-structure delete-popup" id="applyJob">
  <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          ...
          <form id="applyConfirmed" method="POST" action="<?php echo e(route('candidateAppliedJob')); ?>">
                <?php echo csrf_field(); ?>             <!-- Modal body -->
...
<?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/candidate/jobs/components/apply-modal.blade.php ENDPATH**/ ?>