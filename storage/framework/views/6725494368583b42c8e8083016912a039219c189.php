    ...
    <div
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item"
                id="edit-btn"
                data-target="#reqEidtUser" data-id="<?php echo e($id); ?>" href="javascript:void(0)">
                <img src="<?php echo e(asset('public/assets/frontend/img/pencil.svg')); ?>"
                    alt="" />
                <span>Edit</span>
            </a>
...
</div><?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/company/components/action.blade.php ENDPATH**/ ?>