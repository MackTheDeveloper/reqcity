                        ...
                        <div class="accounts-boxlayouts">
                            ...
                            <div class="ac-boxlayouts-desc">
                                <div class="email-updates-request">
                                    <p>Send email notification to <?php echo e($email); ?> when...</p>
                                    <div class="emailupdates-checknow">
                                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="input-groups">
                                            <label class="ck"><?php echo e($notification['label']); ?>

                                                <input type="checkbox" class="notification" <?php echo e(in_array($notification['id'],$userNotification ) ? ' checked' : ''); ?> data-permId="<?php echo e($notification['id']); ?>" id="<?php echo e($notification['id']); ?>" />
...
<script>
    $(document).on('change', '.notification', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('updateNotificationSettingRecruiter')); ?>",
            type: "GET",
            data: {
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/recruiter/notification-setting/index.blade.php ENDPATH**/ ?>