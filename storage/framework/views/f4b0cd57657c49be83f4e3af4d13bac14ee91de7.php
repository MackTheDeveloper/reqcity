<?php $__env->startSection('title','Password & Security'); ?>
                        ...
                        <div class="accounts-boxlayouts">
                            <div class="ac-boclayout-header">
                                ...
                                <div class="boxlayouts-edit">
                                    <a href="<?php echo e(route('showPasswordSecurityFormCandidate')); ?>"><img src="<?php echo e(asset('public/assets/frontend/img/pencil.svg')); ?>" /></a>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/reqcity/resources/views/frontend/candidate/password-security/password-security.blade.php ENDPATH**/ ?>