    ...
    {            
        try {               
            ...
            if($role->save())
            {
                ...
                // return redirect(config('app.adminPrefix').'/user/role/list');
                $notification = array(
                    'message' => config('message.Role.RoleAddSuccess'), 
                    'alert-type' => 'success'
                );
                return redirect(config('app.adminPrefix').'/user/role/list')->with($notification);                                          
            }                                                            
        } catch (Exception $e) {
            Session::flash('error', $e->getMessage());            
            return redirect(config('app.adminPrefix').'/user/role');
        }
    }
